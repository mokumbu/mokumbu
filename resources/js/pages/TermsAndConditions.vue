		...
		<div class="container container-narrow py-4">
			...
			<div class="card card-md">
				<div class="card-body">
					...
					<p>
						Ao aceder ou utilizar a plataforma <strong>MoKumbu</strong> (“Plataforma”, “Serviço”),
						operada por <strong>Dorivaldo Valentim</strong>, concorda com os presentes Termos e
						Condições.
						Se não concordar com estes termos, não deverá utilizar a Plataforma.
					</p>

					<h3>1. Elegibilidade</h3>
					<p>
						A utilização da Plataforma é permitida apenas a utilizadores com idade mínima de 16 anos.
						Ao criar uma conta, declara que cumpre este requisito.
					</p>

					<h3>2. Criação de Conta</h3>
					<p>
						A autenticação na Plataforma é realizada através do Firebase Authentication,
						podendo incluir login por e-mail e palavra-passe ou provedores sociais
						(como Google, Apple ou Facebook).
					</p>
					<p>
						O utilizador é responsável por manter a confidencialidade da sua conta
						e por todas as atividades realizadas através dela.
					</p>

					<h3>3. Utilização da Plataforma</h3>
					<p>
					...
					<ul>
						...
						<li>Não introduzir código malicioso, spam ou conteúdos ilegais.</li>
					</ul>

					<h3>4. Conteúdo</h3>
					<p>
						Qualquer conteúdo submetido pelo utilizador é da sua exclusiva responsabilidade.
						Reservamo-nos o direito de remover conteúdos que violem estes Termos
						ou a legislação aplicável.
					</p>

					<h3>5. Suspensão ou Encerramento de Conta</h3>
					<p>
						Poderemos suspender ou encerrar contas que violem estes Termos,
						sem aviso prévio, sempre que necessário para garantir a segurança da Plataforma.
					</p>

					<h3>6. Limitação de Responsabilidade</h3>
					<p>
						A Plataforma é disponibilizada “tal como está”.
					...
					<p>
						...
						As alterações entrarão em vigor após a sua publicação nesta página.
					</p>

					<h3>8. Contacto</h3>
					<p>
						Para qualquer questão relacionada com estes Termos, pode contactar-nos através de:
						<br>
